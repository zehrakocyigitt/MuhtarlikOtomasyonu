...
{
    public class AdresteOturanKisiRepository : Repository<AdresteOturanKisi>, IAdresteOturanKisiRepository
    {
        private readonly MuhtarlikOtomasyonuContext _ctx;

        public AdresteOturanKisiRepository(MuhtarlikOtomasyonuContext ctx) : base(ctx)
        {
            _ctx = ctx;
        }
    }
